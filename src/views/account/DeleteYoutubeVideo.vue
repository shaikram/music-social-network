<template>
    <div id="DeleteYoutubeVideo" class="container mx-auto max-w-4xl pt-20 pb-20 px-6">
        ...
        <div class="bg-white rounded px-8 pt-6 pb-8">
            <div class="flex flex-wrap items-center">
                ...
                <div class="w-1/4 mr-auto mt-2 text-lg p-1 text-gray-900">
                    1. Sample Title
                    <iframe class="w-full h-20" src="https://www.youtube.com/embed/2TDN50OzZNk?autoplay=0"></iframe>
                </div>
